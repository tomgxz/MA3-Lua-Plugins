...
function pos_create_timing_macros(first_macro,in_declared_timings,name_prefix,progress_bar_time,DP)
    ...
    for i = 1, #fades do
		...
		macro_pool[macro_num][1]:Set('Command', 'SetUserVar "PosFadeX" '..fades[i]..' /nu')
		macro_pool[macro_num][2]:Set('Command', 'Set MAtricks "'..name_prefix..'*" property "FadefromX" $PosFadeX /nu')
		macro_pool[macro_num][3]:Set('Command', 'Set MAtricks "'..name_prefix..'*" property "FadetoX" $PosFadeX /nu')
		macro_pool[macro_num][5]:Set('Command', 'Set Sequence "'..name_prefix..'*" Cue "offcue" CueFade $PosFadeX /nu')
    ...
    for i = 1, #delays_from do
		...
		macro_pool[macro_num][1]:Set('Command', 'SetUserVar "PosDelayFromX" '..delays_from[i]..' /nu')
		macro_pool[macro_num][2]:Set('Command', 'Set MAtricks "'..name_prefix..'*" property "delayfromX" $PosDelayFromX /nu')
    ...
    for i = 1, #delays_to do
		...
		macro_pool[macro_num][1]:Set('Command', 'SetUserVar "PosDelayToX" '..delays_to[i]..' /nu')
		macro_pool[macro_num][2]:Set('Command', 'Set MAtricks "'..name_prefix..'*" property "delaytoX" $PosDelayToX /nu')
        macro_pool[macro_num][4]:Set('Command',line6)
    ...
    for i = 1, #groups do
		...
		macro_pool[macro_num][1]:Set('Command', 'SetUserVar "PosGroupX" '..groups[i]..' /nu')
		macro_pool[macro_num][2]:Set('Command', 'Set MAtricks "'..name_prefix..'*" property "XGroup" $PosGroupX /nu')
        macro_pool[macro_num][4]:Set('Command',line6)
    ...
    for i = 1, #wings do
		...
		macro_pool[macro_num][1]:Set('Command', 'SetUserVar "PosWingsX" '..wings[i]..' /nu')
		macro_pool[macro_num][2]:Set('Command', 'Set MAtricks "'..name_prefix..'*" property "XWings" $PosWingsX /nu')
        macro_pool[macro_num][4]:Set('Command',line6)
